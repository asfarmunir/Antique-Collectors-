            ...
            <div>
                ...
                <div className=" bg-[#F9F8F3] flex flex-col  pt-20 pb-16 px-4 relative">
                    <div className="px-10">
                        <div className="absolute -top-10 right-8">
                            <Image src="/images/about/about1.png" width={150} height={80} alt="about pic1" />

                        </div>
                        <div className="absolute md:-bottom-8 md:block hidden">
                            <Image src="/images/about/about2.png" width={150} height={80} alt="about pic1" />

                        </div>

                        <div className="absolute left-4 top-4 md:hidden block ">
                            <Image src="/images/about/about2.png" width={130} height={80} alt="about pic1" />
                ...
                <section className="py-4 px-4 md:px-6 lg:px-12 flex flex-col-reverse md:flex-row gap-4 pt-20">
                    <div className="w-full md:w-1/2">
                        <Image src="/images/about/about3.png" width={480} height={250} alt="about pic1" />
                    </div>

                    <div className="w-full  md:w-1/2 flex flex-col justify-center ">  {/* Updated this div */}
                        <h1 className="font-playfair text-[26px] md:text-[32px]">Discover Antiques from all over the World</h1>
                ...
                <section className="px-4 md:px-6 lg:px-12  pt-10">
                    ...
                    <div>
                        <h1 className="text-[26px] md:text-[32px] font-playfair">Follow your favorite dealers</h1>
                        <p className="text-[#666666] py-2 text-[14px]">Follow the people you love and see all their new posts. Or go to the categories and hunt down specific pieces.</p>
                ...
                <section className="px-4 md:px-6 lg:px-12  pt-10 ">
                    ...
                    <div className="grid md:grid-cols-5 mb-8">
                        ...
                        <div className="col-span-2 px-4 md:p-6">
                            <h1 className="text-[24px] md:text-[28px] font-playfair">Liaise With Dealers Privately</h1>
                            <p className="text-xs text-[#666666] py-2 mt-2">Liaise with dealers with our direct message, or their email, and arrange payment offline or on their website. The Antique Collector does not add fees or commission, or share your data with third parties unless directly related to app functionality.</p>
                        </div>
                        ...
                        <div className="col-span-2 p-6">
                            <h1 className="text-[24px] md:text-[28px] font-playfair">Become a dealer and be seen</h1>
                            <p className="text-[#666666] text-xs py-0 my-2">When you join our community your followers will be able to see all your new finds in the daily feed, in chronological order. Our algorithm does not choose what you see, you see who you follow in real time. No silly dances required for visibility.</p>
                        </div>
                    </div>
                ...
                <section className="bg-[#463F3A] flex text-white flex-col items-center justify-center ">
                    <div className="w-full px-3 md:w-1/2 py-10 text-center">
                        <h1 className="text-[24px] md:text-[32px] font-playfair capitalize">How to Join our Community</h1>
                        <p className="text-[#EBE9E0] text-[14px] py-2">
                        ...
                        <p className="uppercase text-[16px] tracking-wide py-3">We are offering free seller membership for early adopters</p>
                        <p className="font-playfair uppercase text-sm">Join now and be ahead of the crowd!</p>
                        <div className="flex flex-row items-center justify-center mt-4">
                            <Button label="become a seller" className="uppercase bg-[#EBE9E0] text-[#463F3A] hover:opacity-80 text-xs px-8 w-1/2" />
                        </div>
                    </div>
                </section>
