  ...
  return (
    <div className="relative inline-block w-full">
      ...
      <button
        ...
        className={`${className} w-full bg-gray-200 text-[#919089] text-sm py-2 px-4 rounded flex items-center justify-between`}
      ...
      {isOpen && (
        <ul
          className="absolute z-10 w-full bg-white border text-sm border-gray-300 rounded mt-1 shadow-lg"
          role="listbox"
        >
          {items.map((item) => (
            <li
